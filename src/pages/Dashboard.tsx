...
import { SomeDataFetchingComponent } from './SomeDataFetchingComponent';
...
const Dashboard = ({ data, permissions }) => {
  if (data.loading) {
    return <div>Loading...</div>;
  }

  if (permissions.checkFailed) {
    // Return cached or empty data instead of a blank page
    return <div>No data available, but you can check your account settings.</div>;
  }
  ...
  return (
    <div>
      ...
      <SomeDataFetchingComponent data={data} />
    </div>
  );
};
